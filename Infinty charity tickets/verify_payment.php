...
if($status == "successful"){
	...
	header("Location:thank_you.php?message=' Hello ".$name." Your ticket has been purchased successfully, Your seatNumber is ".$seatNumber." Thank you for supporting Infinty Charity Organisation'  ");
